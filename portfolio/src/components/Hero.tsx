...
import profileImage from 'figma:asset/eef37fd67dd772f11e2c1ec20a16bfb937bc3485.png';
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex flex-wrap gap-2">
                {['Product Strategy', 'Business Analysis', 'Agile Development', 'Financial Services', 'Stakeholder Management'].map((skill) => (
