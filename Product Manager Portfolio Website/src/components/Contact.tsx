...
const Contact = () => {
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'hariau10@gmail.com',
      action: 'mailto:hariau10@gmail.com'
    },
    {
      icon: Linkedin,
      label: 'LinkedIn',
      value: '/in/harikrishnan-au',
      action: 'https://www.linkedin.com/in/harikrishnan-au-a1338785/'
    },
    {
      icon: Twitter,
      label: 'Twitter',
    ...
    },
    {
      ...
      label: 'GitHub',
      value: '/hariau',
      action: 'https://github.com/hariau'
    }
  ];
  ...
  const availability = {
    ...
    roles: ['Senior PM', 'Product Owner', 'Product Consultant']
  };
